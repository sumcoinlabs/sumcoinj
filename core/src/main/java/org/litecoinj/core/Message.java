...
public abstract class Message {
    ...
    /**
     * Serialize this message to a byte array that conforms to the sumcoin wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the sumcoin wire format.
     *
     * @param stream
     * @throws IOException
     */
