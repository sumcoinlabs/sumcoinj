...
public class TestNet3Params extends AbstractBitcoinNetParams {
    public TestNet3Params() {
        ...
        dnsSeeds = new String[] {
                "testnet-seed.sumcoin.jonasschnelli.ch", // Jonas Schnelli
                "testnet-seed.bluematt.me",              // Matt Corallo
                "testnet-seed.sumcoin.petertodd.org",    // Peter Todd
                "testnet-seed.sumcoin.schildbach.de",    // Andreas Schildbach
        };
        addrSeeds = null;
    ...
    public void checkDifficultyTransitions(final StoredBlock storedPrev, final Block nextBlock,
        ...
        if (!isDifficultyTransitionPoint(storedPrev.getHeight()) && nextBlock.getTime().after(testnetDiffDate)) {
            ...
            // There is an integer underflow bug in sumcoin-qt that means mindiff blocks are accepted when time
            // goes backwards.
