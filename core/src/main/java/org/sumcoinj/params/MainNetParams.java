...
public class MainNetParams extends AbstractBitcoinNetParams {
    ...
    public MainNetParams() {
        ...
        addressHeader = 63; //SUM
        dumpedPrivateKeyHeader = 128 + addressHeader;  // todo
        p2shHeader = 5;  //sum
        p2shHeader2 = 200; //sum

        acceptableAddressCodes = new int[] { addressHeader, p2shHeader,p2shHeader2 };
        port = 3333;
        packetMagic = 0xfbc0b6dbl;  // todo
        bip32HeaderPub = 0x019da462; //The 4 byte header that serializes in base58 to "xpub".  //todo
        bip32HeaderPriv = 0x019d9cfe; //The 4 byte header that serializes in base58 to "xprv"  //todo
        ...
        genesisBlock.setTime(1554579000L); //sum
        genesisBlock.setNonce(133964L);  //sum
        id = ID_MAINNET;
        subsidyDecreaseBlockCount = 1000000;
        spendableCoinbaseDepth = 100;
        String genesisHash = genesisBlock.getHashAsString();
        checkState(genesisHash.equals("37d4696c5072cd012f3b7c651e5ce56a1383577e4edacc2d289ec9b25eebfd5e"), //sum
                genesisHash);
        ...
        checkpoints.put(2880, Sha256Hash.wrap("31dfe91b64cbbb167b4e4c644ad7b008bb4bb8ca4e42aea02f938f445dc37cff"));
