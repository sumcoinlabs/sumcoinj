...
public class Wallet extends BaseTaggableObject
    ...
    /**
     * Returns the amount of sumcoin ever received via output. <b>This is not the balance!</b> If an output spends from a
    ...
    /**
     * Returns the amount of sumcoin ever sent via output. If an output is sent to our own wallet, because of change or
