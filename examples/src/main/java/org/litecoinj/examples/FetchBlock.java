...
public class FetchBlock {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (opts.has("help")) {
                System.out.println("usage: org.litecoinj.examples.FetchBlock [--localhost] <blockHash>");
            ...
            System.err.println("usage: org.litecoinj.examples.FetchBlock [--localhost] <blockHash>");
