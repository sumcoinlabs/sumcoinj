...
// This file shows how to use sumcoinj from Javascript.
// To run, grab the sumcoinj bundled JAR and then do something like this:
//
//   jjs -cp sumcoinj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp sumcoinj-0.12-bundled.jar
//
...
//
//   jjs -cp sumcoinj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And sumcoinj is a threaded library. This means you
